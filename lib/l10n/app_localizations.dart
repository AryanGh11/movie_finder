...
abstract class AppLocalizations {
  ...
  /// No description provided for @searchForCast.
  ///
  /// In en, this message translates to:
  /// **'Search for cast ...'**
  String get searchForCast;
  ...
  /// No description provided for @openInNeterplay.
  ///
  /// In en, this message translates to:
  /// **'Open in Neterplay'**
  String get openInNeterplay;

  /// No description provided for @openInTelegramBot.
  ///
  /// In en, this message translates to:
  /// **'Open in Telegram Bot'**
  String get openInTelegramBot;
}
