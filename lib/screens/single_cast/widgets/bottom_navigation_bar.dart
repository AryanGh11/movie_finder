...
class SingleCastScreenBottomNavigationBar extends StatelessWidget {
  final Cast cast;

  const SingleCastScreenBottomNavigationBar({super.key, required this.cast});
        ...
        children: [
          Flexible(
            ...
            child: CustomElevatedButton(
              ...
              onPressed: () =>
                  neterplayDownloadOption[DownloadOptionsKeys.onSubmit](cast),
              variant:
          ...
          Expanded(
            ...
            child: IconButton(
              ...
              onPressed: () =>
                  telegramBotDownloadOption[DownloadOptionsKeys.onSubmit](cast),
              style: ButtonStyle(
