...
class Movie {
  ...
  String? get posterPath => _posterPath != null
      ? 'https://image.tmdb.org/t/p/original$_posterPath'
      : null;
  ...
  int? get releaseYear => (releaseDate != null && releaseDate!.isNotEmpty)
      ? int.parse(releaseDate!.split("-")[0])
      : null;
